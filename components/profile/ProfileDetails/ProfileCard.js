...
const ProfileCard = ({
  ...
  <div className="w-96 md:w-96 lg:w-96 flex flex-col items-center mx-2 my-3 p-6 bg-white rounded-xl text-black">
    <div className="w-full flex-col items-center justify-center py-4">
      ...
      />
      <div className="text-2xl mt-4"><a href="/profile">{name}</a></div>
